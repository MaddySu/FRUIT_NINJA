...
# Constants
FRUIT_SIZE = (100, 100)  # Width, Height
SCREEN_WIDTH, SCREEN_HEIGHT = 1280, 720  # Updated window size
FRUIT_SPAWN_PROBABILITY = 0.05  # Probability of spawning a fruit per frame
GAME_DURATION = 15 * 1  # 15 minutes in seconds
...
window_overlay_image = load_and_resize_image('bg.png', (1280, 720))
finger_image = load_and_resize_image('2.png', (70, 70))  # Example size

# Initialize pygame for sound
pygame.mixer.init()
cut_sound = pygame.mixer.Sound('sound.mp3')
...
while True:
    ...
    if game_start:
        ...
        # Display timer
        cv2.putText(frame, timer_text, (SCREEN_WIDTH - 200, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
        ...
        if random.random() < FRUIT_SPAWN_PROBABILITY:
            ...
            for _ in range(num_fruits):
                fruits_on_screen.append({
                    ...
                    'y': 0,
                    'speed': random.randint(5, 15),  # Random speed between 5 and 15
                    'cut': False
                })
